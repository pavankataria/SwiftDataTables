...
This release represents the most significant update to SwiftDataTables since its inception. I've modernised the entire architecture with significant changes:

- **iOS 17+ minimum** deployment target (previously iOS 13)
- **New APIs** for typed data, diffing, and cell sizing
- **Breaking changes** in some internal APIs

Please review the Migration Guide below for upgrade steps. The highlights include:
